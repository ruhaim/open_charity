...
<div class="get-involved" >
	<div class="get-involved__image">
		<?php print render($content['field_full_width_image'][0]); ?>
	</div>
	<div class="get-involved__content">
		<h3 class="get-involved__title">
		...
		<div class="get-involved__link">
			<?php print render($content['field_full_width_link'][0]); ?>
		</div>
	</div>
